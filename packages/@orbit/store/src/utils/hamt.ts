/**
 * Source: https://github.com/mattbierner/hamt
 * Author: Matt Bierner
 * MIT license
 */
...
HAMTMap.prototype.isEmpty = function () {
    return isEmpty(this);
};
...
HAMTMap.prototype.removeHash = HAMTMap.prototype.deleteHash = function (hash, key) {
...
HAMTMap.prototype.remove = HAMTMap.prototype.delete = function (key) {
...
HAMTMapIterator.prototype[Symbol.iterator] = function () {
    return this;
};
...
HAMTMap.prototype.entries = HAMTMap.prototype[Symbol.iterator] = function () {
    return entries(this);
};
...
var values = hamt.values = HAMTMap.prototype.values = function (map) {
...
HAMTMap.prototype.count = function () {
    return count(this);
};

Object.defineProperty(HAMTMap.prototype, 'size', {
    get: HAMTMap.prototype.count
});
