 ...
 * @param [context] Context in which `fn` should be called
 * @param {Object} [options]
 * @param {String} [options.autoProcess=true] Are actions automatically processed as soon as they are pushed?
 * @constructor
 */
