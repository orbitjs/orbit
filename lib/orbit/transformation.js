...
export default Class.extend({
  ...
  pushCompletedOperation: function(operation, result) {
    ...
    this.inverseOperations = this.inverseOperations.concat(result.inverseOperations);
    this.completedOperations.push([operation, result]);
  },
