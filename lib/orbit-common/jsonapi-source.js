...
var JSONAPISource = Source.extend({
      ...
      if (op === 'add') {
        ...
        return this.ajax(this.buildURL(type), 'POST', {data: this.serialize(type, data)}).then(
          function(raw) {
            ...
            raw[_this.schema.pluralize(type)][_this.schema.models[type].idField] = id;
  ...
  _find: function(type, id) {
    var remoteId,
        remoteIdField = this.schema.models[type].idDef.remote;
    ...
    if (id && (typeof id === 'number' || typeof id === 'string')) {
      ...
      for (var i = 0, l = id.length; i < l; i++) {
        localId =  id[i];
        if (localId && typeof localId === 'object' && localId[remoteIdField]) {
          remoteId = localId[remoteIdField];
        } else {
    ...
    } else if (id && typeof id === 'object' && id[remoteIdField]) {
      return this._findOne(type, id[remoteIdField]);
