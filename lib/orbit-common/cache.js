...
import CacheTransformer from './cache-transformer';
...
export default Class.extend({
  init: function(schema, options) {
    ...
    this._cacheTransformer = new CacheTransformer(retrieve, transformTarget, this._schema, processors);
  },
  ...
  reset: function(data) {
    ...
    this._cacheTransformer.reset(data);
  },
  ...
  transform: function(operation) {
    return this._cacheTransformer.transform(this._normalizeOperation(operation));
  },
