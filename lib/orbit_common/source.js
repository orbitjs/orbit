...
Source.prototype = {
  ...
  init: function(schema, options) {
    ...
    Requestable.extend(this, ['find', 'add', 'update', 'patch', 'remove', 'addLink', 'removeLink']);
  },
  ...
  _addLink: function(type, id, property, value) {
  ...
  _removeLink: function(type, id, property, value) {
